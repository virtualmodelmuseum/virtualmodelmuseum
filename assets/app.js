...
const I18N = {
  en: {
    ...
    controlsLabel: 'Gallery controls', featuredLabel: 'Featured Donati models', galleryLabel: 'Model gallery',
    searchPlaceholder: 'Search model, kit, scale or text...', allYears: 'All years', allScales: 'All scales', reset: 'Reset',
    footer: 'Virtual Model Museum — a static archive of scale modelling.', close: 'Close', previousPhoto: 'Previous photo', nextPhoto: 'Next photo',
    featured: 'Featured · Donati', kit: 'Kit', scale: 'Scale', post: 'post', posts: 'posts', image: 'image', images: 'images', photo: 'photo', photos: 'photos'
  },
  it: {
    ...
    controlsLabel: 'Controlli della galleria', featuredLabel: 'Modelli Donati in evidenza', galleryLabel: 'Galleria dei modelli',
    searchPlaceholder: 'Cerca modello, kit, scala o testo...', allYears: 'Tutti gli anni', allScales: 'Tutte le scale', reset: 'Azzera',
    footer: 'Virtual Model Museum — un archivio statico di modellismo.', close: 'Chiudi', previousPhoto: 'Foto precedente', nextPhoto: 'Foto successiva',
    featured: 'In evidenza · Donati', kit: 'Kit', scale: 'Scala', post: 'post', posts: 'post', image: 'immagine', images: 'immagini', photo: 'foto', photos: 'foto'
  },
  de: {
    ...
    intro2: 'Ziel ist es nicht, Perfektion zur Parade antreten zu lassen, sondern einen liebevollen Blick auf die vielen reizvollen Ecken des Modellbaus zu werfen: Flugzeuge, Automobile, Militärfahrzeuge und jene kleinen mechanischen Charaktere, die dieses Hobby so unerschöpflich charmant machen.',
    controlsLabel: 'Galerie-Steuerung', featuredLabel: 'Hervorgehobene Donati-Modelle', galleryLabel: 'Modellgalerie',
    searchPlaceholder: 'Modell, Bausatz, Maßstab oder Text suchen...', allYears: 'Alle Jahre', allScales: 'Alle Maßstäbe', reset: 'Zurücksetzen',
    footer: 'Virtual Model Museum — ein statisches Archiv des Modellbaus.', close: 'Schließen', previousPhoto: 'Vorheriges Foto', nextPhoto: 'Nächstes Foto',
    featured: 'Hervorgehoben · Donati', kit: 'Bausatz', scale: 'Maßstab', post: 'Beitrag', posts: 'Beiträge', image: 'Bild', images: 'Bilder', photo: 'Foto', photos: 'Fotos'
  },
  fr: {
    ...
    controlsLabel: 'Commandes de la galerie', featuredLabel: 'Modèles Donati à la une', galleryLabel: 'Galerie de modèles',
    searchPlaceholder: 'Rechercher modèle, kit, échelle ou texte...', allYears: 'Toutes les années', allScales: 'Toutes les échelles', reset: 'Réinitialiser',
    footer: 'Virtual Model Museum — une archive statique de modélisme.', close: 'Fermer', previousPhoto: 'Photo précédente', nextPhoto: 'Photo suivante',
    featured: 'À la une · Donati', kit: 'Kit', scale: 'Échelle', post: 'publication', posts: 'publications', image: 'image', images: 'images', photo: 'photo', photos: 'photos'
  },
  ru: {
    ...
    controlsLabel: 'Управление галереей', featuredLabel: 'Избранные модели Donati', galleryLabel: 'Галерея моделей',
    searchPlaceholder: 'Поиск модели, набора, масштаба или текста...', allYears: 'Все годы', allScales: 'Все масштабы', reset: 'Сбросить',
    footer: 'Virtual Model Museum — статический архив стендового моделизма.', close: 'Закрыть', previousPhoto: 'Предыдущее фото', nextPhoto: 'Следующее фото',
    featured: 'Избранное · Donati', kit: 'Набор', scale: 'Масштаб', post: 'публикация', posts: 'публикации', image: 'изображение', images: 'изображения', photo: 'фото', photos: 'фото'
  },
  ja: {
    ...
    controlsLabel: 'ギャラリー操作', featuredLabel: 'Donati 注目モデル', galleryLabel: 'モデルギャラリー',
    searchPlaceholder: 'モデル、キット、スケール、本文を検索...', allYears: 'すべての年', allScales: 'すべてのスケール', reset: 'リセット',
    footer: 'Virtual Model Museum — スケールモデルの静的アーカイブ。', close: '閉じる', previousPhoto: '前の写真', nextPhoto: '次の写真',
    featured: '注目 · Donati', kit: 'キット', scale: 'スケール', post: '件の投稿', posts: '件の投稿', image: '枚の画像', images: '枚の画像', photo: '枚の写真', photos: '枚の写真'
  },
  zh: {
    kicker: '欢迎来到我的收藏！',
    intro1: '这套收藏由我的父亲在将近七十年前开始，此后便一直安静地积累着属于自己的风韵。',
    intro2: '这里的目的并不是展示完美，而是以温情的目光看一看比例模型的诸多迷人角落：飞机、汽车、军用车辆，以及那些让这项爱好显得无穷可爱的小小机械角色。',
    controlsLabel: '图库控制', featuredLabel: 'Donati 精选模型', galleryLabel: '模型图库',
    searchPlaceholder: '搜索模型、套件、比例或文字...', allYears: '所有年份', allScales: '所有比例', reset: '重置',
    footer: 'Virtual Model Museum — 比例模型静态档案。', close: '关闭', previousPhoto: '上一张照片', nextPhoto: '下一张照片',
    featured: '精选 · Donati', kit: '套件', scale: '比例', post: '篇帖子', posts: '篇帖子', image: '张图片', images: '张图片', photo: '张照片', photos: '张照片'
  },
  fe: window.VMM_FERRARESE_I18N || {
    kicker: 'Benvegnu int la mi culizion!',
    intro1: 'Sta culizion l\'e stada tachÃ¨da da mi pÃ dar quasi setant\'an fa.',
    intro2: 'L\'intent l\'an Ã¨ brisa quel ad mustrÃ r la perfezion, mo ad dÃ¨r un\'uciadina cun afÃ¨t ai tanti cantÃ³n dal mudelÃ¬sum.',
    controlsLabel: 'Cumand dla galeria',
    featuredLabel: 'Mudel Donati in evidenza',
    galleryLabel: 'Galeria di mudel',
    searchPlaceholder: 'Zerca mudel, scatula, scala o test...',
    allYears: 'Tut j\'an',
    allScales: 'Tut al scali',
    reset: 'Azera',
    footer: 'Virtual Model Museum â€” un archiv static ad mudelisum.',
    close: 'Sera',
    previousPhoto: 'Foto prima',
    nextPhoto: 'Foto dop',
    featured: 'In evidenza Â· Donati',
    kit: 'Kit',
    scale: 'Scala',
    post: 'post',
    posts: 'post',
